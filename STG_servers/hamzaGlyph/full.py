...
def run_1(source, 
        weights=ROOT / 'runs/train/exp3/weights/best.pt',#'yolov5/runs/train/exp3/weights/best.pt',#ROOT / 'yolov5s.pt',  # model path or triton URL
         #ROOT / 'tstImg_5.jpg',  #'yolov5/tstImg_5.jpg',#ROOT / 'data/images',  # file/dir/URL/glob/screen/0(webcam)
        data=ROOT / 'data_1.yaml',#'yolov5/data_1.yaml',#ROOT / 'data/coco128.yaml',  # dataset.yaml path
...
@smart_inference_mode()
def run_2(
        weights_2=ROOT / 'runs/train/exp6/weights/best.pt',  #'yolov5/runs/train/exp6/weights/best.pt',#ROOT / 'yolov5s.pt',  # model path or triton URL
        source_2=None ,#ROOT / 'roi.jpg',  #'yolov5/roi.jpg',#=ROOT / 'data/images',  # file/dir/URL/glob/screen/0(webcam)
        data=ROOT / 'data_2.yaml',  #'yolov5/data_2.yaml',#ROOT / 'data/coco128.yaml',  # dataset.yaml path
    ...
    if source_2 is None:
        source_2 = run_1(source=ROOT / 'tstImg_5.jpg')
...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data_1.yaml', help='(optional) dataset.yaml path')
...
def parse_opt_2():
    ...
    parser.add_argument('--source_2', type=str, default=None , help='file/dir/URL/glob/screen/0(webcam)')#ROOT / 'roi.jpg'
    parser.add_argument('--data', type=str, default=ROOT / 'data_2.yaml', help='(optional) dataset.yaml path')
