...
def run_2(
        weights=ROOT / 'runs/train/exp8/weights/best.pt',  #'yolov5/runs/train/exp6/weights/best.pt',#ROOT / 'yolov5s.pt',  # model path or triton URL
        source =ROOT / 'sec_roi.jpg',  #'yolov5/roi.jpg',#=ROOT / 'data/images',  # file/dir/URL/glob/screen/0(webcam)
    ...
    if webcam:
        ...
        dataset = LoadStreams(source, img_size=imgsz_2, stride=stride, auto=pt, vid_stride=vid_stride)
        bs = len(dataset)
    elif screenshot:
...
def parse_opt_2():
    ...
    parser.add_argument('--source', type=str, default='sec_roi.jpg', help='file/dir/URL/glob/screen/0(webcam)')#ROOT / 'roi.jpg'
